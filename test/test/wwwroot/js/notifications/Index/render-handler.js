    ...
    items.forEach((notification) => {
      const row = `
        ...
        notification.id
          ...
          <td>${formatHandler.formatEmailContent(notification.content)}</td>
          <td>${
            notification.isRead
          ...
          <td>${formatHandler.formatEmailContent(notification.contentEn)}</td>
          <td>${
            notification.urlMobile
              ? `<a href="${notification.urlMobile}" target="_blank">Mobile Link</a>`
              : ""
          }</td>
          <td>${formatHandler.formatEmailContent(notification.reqBody)}</td>
